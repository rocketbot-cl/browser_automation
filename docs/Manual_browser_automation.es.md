...
|Puerto (Optional)|Puerto en el cual se abrirá el navegador automatizado. Si el puerto indicado está ocupado, el módulo tomará el siguiente libre (Opcional)|5002|
...
|ID o sesión|ID único para identificar la sesión del navegador. La primera vez que se abre el navegador con una nueva ID, sera necesario cerrarlo manualmente.|session|
