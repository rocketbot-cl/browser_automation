...
|Porta (Opcional)|Porta em que o navegador automatizado será aberto. Se a porta especificada estiver ocupada, o módulo usará a próxima disponível. (Opcional)|5002|
...
|ID ou sessão|ID único para identificar a sessão do navegador. A primeira vez que você abrir o navegador com um novo ID, será necessário fechá-lo manualmente.|session|
